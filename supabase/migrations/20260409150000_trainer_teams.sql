...
alter table public.profiles
  add column if not exists golfer_team text;
...
begin
  ...
  insert into course_leaders (course_id, user_id, leader_name, hcp, team, is_npc, claimed_at, golfer_sprite, golfer_team)
  values (p_course_id, v_user_id, coalesce(v_golfer_name, 'Golfer'), coalesce(v_hcp, 36), p_team, false, now(), v_golfer_sprite, v_golfer_team)
