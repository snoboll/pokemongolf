-- End battle immediately when a team is fully KO'd (all hp_current = 0),
-- instead of waiting for the final hole. Players then continue in catch mode
-- for the remaining holes client-side.
--
-- Only change vs 20260406140000: winner check includes KO condition.
...
begin
  ...
  -- ── Determine winner: KO (either team wiped) OR final hole ───────────────
  -- When KO happens mid-round, battle ends here; players switch to catch mode
  -- for remaining holes client-side.
