...
class _TeamSelectScreenState extends State<TeamSelectScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          // vs course leader banner — always visible when challenging a leader
          if (widget.leader != null) _VsLeaderBanner(leader: widget.leader!),
            ...
            child: _filtered.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      final isSelected = _selectedDex.contains(
                        species.dexNumber,
                      );
